...
import { AddClinicalForm } from "@/components/form/clinical-form";
import { getServerSession } from "next-auth";
import { getProjectConfig } from "@/services/projectConfig";
import { Button } from "@/components/ui/button";
import Link from "next/link";

export default async function AddClinicalPage({
  params,
  searchParams,
}: {
  ...
  // Fetch project config to check if clinical findings is enabled
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center p-8 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm max-w-md">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">
            Clinical Findings Section Disabled
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            The clinical findings section has been disabled for this project. Please enable it in project settings to use this feature.
          </p>
