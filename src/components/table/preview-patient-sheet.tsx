...
export function PreviewPatientSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange} modal={true} {...props}>
      <SheetContent 
        className="flex flex-col w-full sm:max-w-2xl overflow-y-auto"
      >
        <SheetHeader className="pb-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <div>
                <SheetTitle className="text-2xl">{patient.name || "Patient"}</SheetTitle>
        ...
        <div className="flex-1 overflow-y-auto py-6 space-y-6">
          ...
          <section className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            ...
            <div className="space-y-2">
              ...
              <InfoRow 
                label="Date of Birth" 
                value={patient.dateOfBirth ? format(parseISO(patient.dateOfBirth), "MMMM dd, yyyy") : "Not provided"}
                icon={Calendar}
              />
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-4">
              <div className="space-y-2 text-sm">
                <InfoRow label="Phone Number" value={patient.phoneNumber} icon={Phone} />
            </div>
            </div>
          </section>
          ...
          {/* Location Information */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-green-50 dark:bg-green-950 rounded-lg p-4">
                <h4 className="font-semibold text-sm mb-3 text-green-900 dark:text-green-100">Address</h4>
                <div className="space-y-2 text-sm">
              ...
              {patient.insurance && (
                <div className="bg-purple-50 dark:bg-purple-950 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <InfoRow label="Insurance/Bima Number" value={patient.insurance} />
                  </div>
                </div>
              )}
              </div>
          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <InfoRow 
                  label="Last Updated" 
                  value={patient.updatedAt ? format(new Date(patient.updatedAt), "PPpp") : "N/A"}
                  icon={Calendar}
                />
            </div>
            </div>
