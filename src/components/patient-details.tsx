            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                <div className="grid gap-1">
                  ...
                  <div className="font-medium">Pollen, Penicillin</div>
                </div>
                <div className="grid gap-1">
                  <div className="text-muted-foreground">Conditions</div>
                  <div className="font-medium">Asthma, High Blood Pressure</div>
                </div>
                <div className="grid gap-1">
                  <div className="text-muted-foreground">Medications</div>
                  <div className="font-medium">Albuterol, Lisinopril</div>
                </div>
              </CardContent>
            </Card>
            <Card>
